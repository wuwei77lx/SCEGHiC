...
knitr::opts_knit$set(root.dir = "/mnt/netshare2/liangxuan/data/model/model/data/mouse/skin")
...
weight <- calculateHiCWeights(SCEGdata, species = "Mus musculus", genome = "mm10", focus_gene = c("Krt5", "Krt14"), averHicPath = "/mnt/netshare2/liangxuan/data/mouse_contact/average")
```
