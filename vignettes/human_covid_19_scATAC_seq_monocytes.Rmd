...
knitr::opts_knit$set(root.dir = "/mnt/netshare2/liangxuan/data/model/model/data/human/COVID_19")
...
weight <- calculateHiCWeights(SCEGdata, species = "Homo sapiens", genome = "hg38", focus_gene = "CCR1", averHicPath = "/mnt/netshare2/liangxuan/data/human_contact/AvgHiC")
```
...
Here, the ground truth for CD14+ monocyte is obtained from the [ENCODE database](https://www.encodeproject.org/files/ENCFF684YCT/@@download/ENCFF684YCT.hic).The detailed code for this analysis is publicly available at the [GitHub repository](https://github.com/wuwei77lx/compare_model).
