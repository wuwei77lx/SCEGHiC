...
#' @param cellnames Name of one or more metadata columns to group the
#' cells. Default is the current cell identities.
...
#' @param cellnames Name of one or more metadata columns to group the cells by. Default is the current cell identities.
#' @param atacbinary Logical, whether the aggregated scATAC-seq data need binary?
#' @param k_neigh Number of cells to be aggregated per group.
#' @param max_overlap The maximum overlapping ratio of two groups.
