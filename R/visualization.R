...
#'
#' @param SCEG_HiC_Result SCEG-HiC result.
#' @param species String, indicating the name of the species.It can be either "Homo sapiens" or "Mus musculus".
...
#' @param cellnames Name of one or more metadata columns to group  the cells. Default is the current cell identities.
#'
